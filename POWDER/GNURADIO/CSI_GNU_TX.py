...
class CSI_GNU_TX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "CSI", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("CSI")
        ...
        self.settings = Qt.QSettings("GNU Radio", "CSI_GNU_TX")
        ...
        self.uhd_usrp_sink_0.set_center_freq(3435e6, 0)
...
def main(top_block_cls=CSI_GNU_TX, options=None):
