...
import time
import CSI_GNU_RX_epy_block_0 as epy_block_0  # embedded python block
import sip



class CSI_GNU_RX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "CSI_GNU_RX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("CSI_GNU_RX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "CSI_GNU_RX")
        ...
        self.uhd_usrp_source_0.set_center_freq(3435e6, 0)
        ...
        self.qtgui_time_sink_x_3_0_0.set_y_axis(-1, 1)

        self.qtgui_time_sink_x_3_0_0.set_y_label('Delay Spread', "")
        ...
        self.qtgui_time_sink_x_3_0.set_y_label('Doppler Shift', "")
        ...
        self.qtgui_time_sink_x_3.set_y_label('SNR', "")
        ...
        self.epy_block_0 = epy_block_0.csi_calculator()
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_complex_to_magphase_0, 0), (self.blocks_rms_xx_0, 0))
        ...
        self.connect((self.blocks_rms_xx_0, 0), (self.qtgui_time_sink_x_2, 0))
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.uhd_fpga_fft_0, 'port0'))
        self.connect((self.epy_block_0, 0), (self.qtgui_time_sink_x_3, 0))
        self.connect((self.epy_block_0, 1), (self.qtgui_time_sink_x_3_0, 0))
        self.connect((self.epy_block_0, 2), (self.qtgui_time_sink_x_3_0_0, 0))
        self.connect((self.uhd_fpga_fft_0, 'port0'), (self.qtgui_freq_sink_x_0, 0))
...
def main(top_block_cls=CSI_GNU_RX, options=None):
